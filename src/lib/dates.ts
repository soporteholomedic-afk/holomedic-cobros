...
/** Shape every query-string date param must match (`YYYY-MM-DD`). Exported so server-side validators (e.g. the envios-history search use case) share the page filters' rule. */
