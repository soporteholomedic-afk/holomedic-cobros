...
export async function GET(request: Request): Promise<NextResponse> {
  try {
    ...
    const result = await pool
      .request()
      .input('FechaInicio', mssql.VarChar, fechaInicio)
      .input('FechaFin', mssql.VarChar, fechaFin)
      .input('Param3', mssql.VarChar, null)
      .input('Param4', mssql.VarChar, null)
      .input('Param5', mssql.Int, null)
