...
import { TOTAL_PAGINAS_EVALUACION } from '@/features/evaluacion-osteomuscular/presentation/constants/paginas';
...
export function Paginacion({ totalPaginas = TOTAL_PAGINAS_EVALUACION, paginaActual, baseUrl, onChange }: PaginacionProps) {
